...
g.k.ZA=function(){this.tooltip=new g.CP(this.player,this);g.G(this,this.tooltip);g.GL(this.player,this.tooltip.element,4);this.tooltip.scale=.6;this.lc=new g.ZM(this.player);g.G(this,this.lc);this.qg=new g.V({D:"div",K:"ytp-miniplayer-scrim"});g.G(this,this.qg);this.qg.ya(this.element);this.N(this.qg.element,"click",this.bx);var a=new g.V({D:"button",Ca:["ytp-miniplayer-close-button","ytp-button"],U:{"aria-label":"\ub2eb\uae30"},S:[g.VJ()]});g.G(this,a);a.ya(this.qg.element);this.N(a.element,"click",
this.Ph);a=new g.b0(this.player,this);g.G(this,a);a.ya(this.qg.element);this.Rn=new g.V({D:"div",K:"ytp-miniplayer-controls"});g.G(this,this.Rn);this.Rn.ya(this.qg.element);this.N(this.Rn.element,"click",this.bx);var b=new g.V({D:"div",K:"ytp-miniplayer-button-container"});g.G(this,b);b.ya(this.Rn.element);a=new g.V({D:"div",K:"ytp-miniplayer-play-button-container"});g.G(this,a);a.ya(this.Rn.element);var c=new g.V({D:"div",K:"ytp-miniplayer-button-container"});g.G(this,c);c.ya(this.Rn.element);this.KI=
new g.zO(this.player,this,!1);g.G(this,this.KI);this.KI.ya(b.element);b=new g.wO(this.player,this);g.G(this,b);b.ya(a.element);this.nextButton=new g.zO(this.player,this,!0);g.G(this,this.nextButton);this.nextButton.ya(c.element);this.vg=new g.pP(this.player,this);g.G(this,this.vg);this.vg.ya(this.qg.element);this.Hc=new g.EO(this.player,this);g.G(this,this.Hc);g.GL(this.player,this.Hc.element,4);this.Ow=new g.V({D:"div",K:"ytp-miniplayer-buttons"});g.G(this,this.Ow);g.GL(this.player,this.Ow.element,
4);a=new g.V({D:"button",Ca:["ytp-miniplayer-close-button","ytp-button"],U:{"aria-label":"\ub2eb\uae30"},S:[g.VJ()]});g.G(this,a);a.ya(this.Ow.element);this.N(a.element,"click",this.Ph);a=new g.V({D:"button",Ca:["ytp-miniplayer-replay-button","ytp-button"],U:{"aria-label":"\ub2eb\uae30"},S:[g.$J()]});g.G(this,a);a.ya(this.Ow.element);this.N(a.element,"click",this.aR);this.N(this.player,"presentingplayerstatechange",this.Gc);this.N(this.player,"appresize",this.sb);this.N(this.player,"fullscreentoggled",
this.sb);this.sb()};
